...
DoubleShortDouble  SetDRO;       // void   SetDRO( short code, double value);
...
extern "C" __declspec(dllexport) void SetSetDRO(DoubleShortDouble pFunc)   //void SetDRO( short code, double value );
{
   SetDRO = pFunc; 
}
